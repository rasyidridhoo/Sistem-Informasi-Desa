                                ...
                                <form action="simpan-data-warga.php" method="POST">
                                    ...
                                    ?>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" minlength="16" class="form-control" id="nik" name="nik" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="daerahasal" name="daerahasal" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="alamatsesuaiktpdesaklari" name="alamatsesuaiktpdesaklari" required> </textarea>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="dusunorperum" name="dusunorperum" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="domisilisekarang" name="domisilisekarang" required></textarea>
                                            </div>
                                        </div>
