...
$datastatusrumah_pribadi = mysqli_query($conn, "select * from data_warga where statusrumah='Pribadi'");
$datastatusrumah_sewa = mysqli_query($conn, "select * from data_warga where statusrumah='Sewa'");
$datastatusrumah_numpang = mysqli_query($conn, "select * from data_warga where statusrumah='Numpang(ikut Orangtua/Saudara)'");
