...
#Dashboard Status Rumah
$datastatusrumah_pribadi = mysqli_query($conn, "select * from data_warga where statusrumah='Pribadi' and status='Ada'");
$datastatusrumah_sewa = mysqli_query($conn, "select * from data_warga where statusrumah='Sewa' and status='Ada'");
$datastatusrumah_numpang = mysqli_query($conn, "select * from data_warga where statusrumah='Numpang(ikut Orangtua/Saudara)' and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datastatusrumah_pribadi) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datastatusrumah_sewa) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-danger text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Numpang(ikut Orangtua/Saudara)</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datastatusrumah_numpang) ?></h4>
                                            </div>
