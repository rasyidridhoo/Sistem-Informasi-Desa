...
$datastatusperkawinan_kawin = mysqli_query($conn, "select * from data_warga where statusperkawinan='Kawin'");
$datastatusperkawinan_belumkawin = mysqli_query($conn, "select * from data_warga where statusperkawinan='Belum Kawin'");
$datastatusperkawinan_ceraihidup = mysqli_query($conn, "select * from data_warga where statusperkawinan='Cerai Hidup'");
$datastatusperkawinan_ceraimati = mysqli_query($conn, "select * from data_warga where statusperkawinan='Cerai Mati'");
