...
$datajenisbpjs_ketenagakerjaan = mysqli_query($conn, "select * from data_warga where jenisbpjs='Ketenagakerjaan'");
$datajenisbpjs_mandiri = mysqli_query($conn, "select * from data_warga where jenisbpjs='Mandiri'");
$datajenisbpjs_kis = mysqli_query($conn, "select * from data_warga where jenisbpjs='KIS'");
$datajenisbpjs_ta = mysqli_query($conn, "select * from data_warga where jenisbpjs='Tidak Ada'");
