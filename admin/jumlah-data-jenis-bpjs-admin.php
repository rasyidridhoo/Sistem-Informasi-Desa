...
#Dashboard Jenis BPJS
$datajenisbpjs_ketenagakerjaan = mysqli_query($conn, "select * from data_warga where jenisbpjs='Ketenagakerjaan' and status='Ada'");
$datajenisbpjs_mandiri = mysqli_query($conn, "select * from data_warga where jenisbpjs='Mandiri'  and status='Ada'");
$datajenisbpjs_kis = mysqli_query($conn, "select * from data_warga where jenisbpjs='KIS'  and status='Ada'");
$datajenisbpjs_ta = mysqli_query($conn, "select * from data_warga where jenisbpjs='Tidak Ada'  and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total BPJS Ketenagakerjaan</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbpjs_ketenagakerjaan) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total BPJS Mandiri</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbpjs_mandiri) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-danger text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total BPJS KIS</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbpjs_kis) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-warning text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Tidak Memiliki BPJS</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbpjs_ta) ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
