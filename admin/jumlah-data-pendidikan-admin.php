...
$datapendidikan_tidakbersekolah = mysqli_query($conn, "select * from data_warga where pendidikan='Tidak Bersekolah' and status='Ada'");
$datapendidikan_belumbersekolah = mysqli_query($conn, "select * from data_warga where pendidikan='Belum Sekolah' and status='Ada'");
$datapendidikan_paud = mysqli_query($conn, "select * from data_warga where pendidikan='PAUD' and status='Ada'");
$datapendidikan_tk = mysqli_query($conn, "select * from data_warga where pendidikan='TK' and status='Ada'");
$datapendidikan_sd = mysqli_query($conn, "select * from data_warga where pendidikan='Sekolah Dasar(SD)' and status='Ada'");
$datapendidikan_sltp = mysqli_query($conn, "select * from data_warga where pendidikan='SLTP/SEDERAJAT' and status='Ada'");
$datapendidikan_slta = mysqli_query($conn, "select * from data_warga where pendidikan='SLTA/SEDERAJAT' and status='Ada'");
$datapendidikan_ds = mysqli_query($conn, "select * from data_warga where pendidikan='DIPLOMA/STRATA 1' and status='Ada'");
$datapendidikan_putussekolah = mysqli_query($conn, "select * from data_warga where pendidikan='Putus Sekolah' and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-primary text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Tidak Bersekolah</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_tidakbersekolah) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-success text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Belum Bersekolah</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_belumbersekolah) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-danger text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_paud) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-warning text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_tk) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-primary text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_sd) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-success text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total SLTP/Sederajat</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_sltp) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-danger text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total SLTA/Sederajat</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_slta) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-warning text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Diploma/Strata 1</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_ds) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-primary text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Putus Sekolah</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datapendidikan_putussekolah) ?></h4>
                                            </div>
