...
$datapendidikan_tidakbersekolah = mysqli_query($conn, "select * from data_warga where pendidikan='Tidak Bersekolah'");
$datapendidikan_belumbersekolah = mysqli_query($conn, "select * from data_warga where pendidikan='Belum Sekolah'");
$datapendidikan_paud = mysqli_query($conn, "select * from data_warga where pendidikan='PAUD'");
$datapendidikan_tk = mysqli_query($conn, "select * from data_warga where pendidikan='TK'");
$datapendidikan_sd = mysqli_query($conn, "select * from data_warga where pendidikan='Sekolah Dasar(SD)'");
$datapendidikan_sltp = mysqli_query($conn, "select * from data_warga where pendidikan='SLTP/SEDERAJAT'");
$datapendidikan_slta = mysqli_query($conn, "select * from data_warga where pendidikan='SLTA/SEDERAJAT'");
$datapendidikan_ds = mysqli_query($conn, "select * from data_warga where pendidikan='DIPLOMA/STRATA 1'");
$datapendidikan_putussekolah = mysqli_query($conn, "select * from data_warga where pendidikan='Putus Sekolah'");
