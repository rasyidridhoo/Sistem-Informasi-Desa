...
#Dashboard KTP
$dataktp_klari = mysqli_query($conn, "select * from data_warga where ktp='KTP Desa Klari'");
$dataktp_asal = mysqli_query($conn, "select * from data_warga where ktp='KTP Asal'");
