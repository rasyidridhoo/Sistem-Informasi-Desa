...
#Dashboard KTP
$dataktp_klari = mysqli_query($conn, "select * from data_warga where ktp='KTP Desa Klari' and status='Ada'");
$dataktp_asal = mysqli_query($conn, "select * from data_warga where ktp='KTP Asal' and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total KTP Desa Klari</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($dataktp_klari) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total KTP Asal</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($dataktp_asal) ?></h4>
                                            </div>
