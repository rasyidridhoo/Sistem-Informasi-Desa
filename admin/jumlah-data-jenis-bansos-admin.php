...
$datajenisbansos_pkh = mysqli_query($conn, "select * from data_warga where jenisbansos='PKH'");
$datajenisbansos_bpnt = mysqli_query($conn, "select * from data_warga where jenisbansos='BPNT'");
$datajenisbansos_ta = mysqli_query($conn, "select * from data_warga where jenisbansos='Tidak Ada'");
