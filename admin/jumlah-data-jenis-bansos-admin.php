...
#Dashboard Jenis Bansos
$datajenisbansos_pkh = mysqli_query($conn, "select * from data_warga where jenisbansos='PKH' and status='Ada'");
$datajenisbansos_bpnt = mysqli_query($conn, "select * from data_warga where jenisbansos='BPNT' and status='Ada'");
$datajenisbansos_ta = mysqli_query($conn, "select * from data_warga where jenisbansos='Tidak Ada' and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbansos_pkh) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbansos_bpnt) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-danger text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Tidak Ada</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datajenisbansos_ta) ?></h4>
                                            </div>
