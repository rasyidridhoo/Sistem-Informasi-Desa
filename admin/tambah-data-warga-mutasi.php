                    ...
                    <div class="container-fluid">
                        <div class="card mb-4 mt-4" style="width: 90%; margin:0 auto;">
                            <div class="card-header">
                                <h4 class="text-center" style="font-family: habibi; font-weight: bold;">Tambah Data Mutasi</h4>
                            </div>
                            <form action="simpan-data-mutasi-admin.php" method="post" enctype="multipart/form-data">
                                <div class="card-body">

                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label">Penduduk</label>
                                        <div class="col-sm-6">
                                            <select name="id_warga2" id="id_warga2" class="form-control select2bs4" required>
                                                <option selected="selected">- Pilih Penduduk -</option>
                                                <?php
                                                // ambil data dari database
                                                $query = "select * from data_warga where status='Ada'";
                                                $hasil = mysqli_query($conn, $query);
                                                while ($row = mysqli_fetch_array($hasil)) {
                                                ?>
                                                    <option value="<?php echo $row['id_warga'] ?>">
                                                        <?php echo $row['nik'] ?>
                                                        -
                                                        <?php echo $row['nama'] ?>
                                                    </option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="alamat_mutasi" name="alamat_mutasi" placeholder="Alamat Mutasi" required>
                                        </div>
                                    </div>
