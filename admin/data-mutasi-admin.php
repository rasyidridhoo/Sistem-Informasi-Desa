            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-3">Data Mutasi</h3>
                        <div class="card mb-4">
                            <div class="card-header">
                                <!-- Eksport -->
                                <a href="tambah-data-warga-mutasi.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</button></a>
                                <!-- <button type="button" class="btn btn-warning m-lg-1">PDF</button> -->
                                <a href="../export/export-data-mutasi.php"><button type="button" class="btn btn-secondary">Export Data</button></a>
                            </div>
                            <div class="card-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="hapus-data-mutasi-admin.php? id_warga_mutasi=<?php echo $data['id_warga_mutasi']; ?>"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
