                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <!-- Eksport -->
                                <!-- <button type="button" class="btn btn-warning m-lg-1" id="">PDF</button> -->
                                <a href="../export/export-data-warga.php"><button type="button" class="btn btn-secondary">Export Data</button></a>
                            </div>
                            <div class="card-body">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="edit-data-warga-admin.php? id_warga=<?php echo $data['id_warga']; ?>"><button type=" button" class="btn btn-warning" data-target="#edit">Edit</button></a>

                                                        <a href="hapus-data-warga-admin.php? id_warga=<?php echo $data['id_warga']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
