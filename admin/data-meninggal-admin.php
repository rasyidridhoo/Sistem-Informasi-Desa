            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h3 class="mt-3">Data Meninggal</h3>
                        <div class="card mb-4">
                            <div class="card-header">
                                <!-- Eksport -->
                                <a href="tambah-data-warga-meninggal.php"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</button></a>
                                <!-- <button type="button" class="btn btn-warning m-lg-1">PDF</button> -->
                                <a href="../export/export-data-meninggal.php"><button type="button" class="btn btn-secondary">Export Data</button></a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive mt-3">
                                    <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            $sql = $conn->query("SELECT data_warga.id_warga, data_warga.nik, data_warga.nama, data_warga_meninggal.tanggal_meninggal, data_warga_meninggal.sebab, data_warga_meninggal.id_warga_meninggal from data_warga_meninggal inner join data_warga on data_warga.id_warga=data_warga_meninggal.id_warga1");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-data-meninggal-admin.php? id_warga_meninggal=<?php echo $data['id_warga_meninggal']; ?>"><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit">Edit</button></a>

                                                        <a href="hapus-data-meninggal-admin.php? id_warga_meninggal=<?php echo $data['id_warga_meninggal']; ?>"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete">Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
