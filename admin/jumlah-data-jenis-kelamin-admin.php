...
$datajeniskelamin_laki2 = mysqli_query($conn, "select * from data_warga where jk='Laki-laki'");
$datajeniskelamin_perempuan = mysqli_query($conn, "select * from data_warga where jk='Perempuan'");
