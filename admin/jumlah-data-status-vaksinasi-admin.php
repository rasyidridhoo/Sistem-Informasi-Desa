...
#Dashboard Status Vaksinasi
$datavaksin_sudah = mysqli_query($conn, "select * from data_warga where statusvaksinasi='Sudah' and status='Ada'");
$datavaksin_belum = mysqli_query($conn, "select * from data_warga where statusvaksinasi='Belum' and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Sudah Vaksin</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datavaksin_sudah) ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Belum Vaksin</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datavaksin_belum) ?></h4>
                                            </div>
