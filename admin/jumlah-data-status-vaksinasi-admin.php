...
$datavaksin_sudah = mysqli_query($conn, "select * from data_warga where statusvaksinasi='Sudah'");
$datavaksin_belum = mysqli_query($conn, "select * from data_warga where statusvaksinasi='Belum'");
