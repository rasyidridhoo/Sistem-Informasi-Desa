...
#Main Dahsboard
$datawarga = mysqli_query($conn, "select * from data_warga where status='Ada'");
$datakeluarga = mysqli_query($conn, "select * from users where status_user='warga'");
$datameninggal = mysqli_query($conn, "select * from data_warga_meninggal");
$datamutasi = mysqli_query($conn, "select * from data_warga_mutasi");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Data Warga</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datawarga) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Data Keluarga</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datakeluarga) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-danger text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Data Meninggal</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datameninggal) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6 ">
                                        <div class="card bg-warning text-white mb-4">
                                            <div class="card-body">
                                                <h5>Total Data Mutasi</h5>
                                            </div>
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datamutasi) ?></h4>
                                            </div>
