...
$datastatuskeluarga_suami = mysqli_query($conn, "select * from data_warga where statuskeluarga='Suami'");
$datastatuskeluarga_istri = mysqli_query($conn, "select * from data_warga where statuskeluarga='Istri'");
$datastatuskeluarga_anak = mysqli_query($conn, "select * from data_warga where statuskeluarga='Anak'");
