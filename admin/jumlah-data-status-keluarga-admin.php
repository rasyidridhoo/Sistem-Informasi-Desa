...
#Dashboard Status Keluarga
$datastatuskeluarga_suami = mysqli_query($conn, "select * from data_warga where statuskeluarga='Suami' and status='Ada'");
$datastatuskeluarga_istri = mysqli_query($conn, "select * from data_warga where statuskeluarga='Istri' and status='Ada'");
$datastatuskeluarga_anak = mysqli_query($conn, "select * from data_warga where statuskeluarga='Anak' and status='Ada'");
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-primary text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datastatuskeluarga_suami) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-success text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datastatuskeluarga_istri) ?></h4>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card bg-danger text-white mb-4">
                                            ...
                                            <div class="card-body">
                                                <h4><?php echo mysqli_num_rows($datastatuskeluarga_anak) ?></h4>
                                            </div>
